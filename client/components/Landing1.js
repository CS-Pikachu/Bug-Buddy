    ...
    return (
        <div class="row">
          <div class="col-sm-6">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Have a bug? No Problem!</h5>
          ...
          <div class="col-sm-6">
            <div class="card">
              <div class="card-body">
              <img src='https://raw.githubusercontent.com/CS-Pikachu/Bug-Buddy/42c4b009b321cf32f84a166fe6d591533777db09/client/assets/statistics.svg' alt="landing" width="415" height="250"></img>
              </div>
            </div>
          </div>
        </div>
